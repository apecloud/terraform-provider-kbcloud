...
DEFAULT_DISPLAY_NAME="My MongoDB Cluster"
...
Options:
    ...
    -bm, --backup-method                    Backup method (mongodump)
    ...
    -cfn, --config-file-name                Configuration file name for reconfigure (e.g., mongodb.conf)
...
Examples:
    ...
    ./run.sh -t 1 \\
        ...
        -r 3 \\
        -s 100 \\
        -cc "mongodb.replicaset.mongodb.4c8g.general"
    ...
    ./run.sh -t 6 \\
        -cp '{"storage.wiredTiger.engineConfig.cacheSizeGB": "1"}' \\
        -cfn "mongodb.conf"
