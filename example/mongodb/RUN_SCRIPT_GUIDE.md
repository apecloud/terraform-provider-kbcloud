...
| Backup Method | `-bm` | `--backup-method` | - | Backup method (pbm-physical) |
...
| Config File Name | `-cfn` | `--config-file-name` | - | Configuration file name for reconfigure (e.g., mongodb.conf) |
...
- Uses pbm-physical method for logical backups
