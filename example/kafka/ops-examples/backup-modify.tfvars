...
# ============================================================================
# Note: Kafka does not support PITR
# ============================================================================
# pitr_enabled = true
# continuous_backup_method = ""  # Not supported for Kafka
...
# ============================================================================
# Note: Kafka does not support incremental backup
# ============================================================================
# incremental_backup_enabled = true  # Not supported for Kafka
# incremental_cron_expression = "0 */6 * * *"  # Not supported for Kafka
...
# Use Case 1: Production Environment - Daily backup with extended retention
# --------------------------------------------------------------------------
# auto_backup = true
# auto_backup_method = "topics"
# cron_expression = "0 2 * * *"
