...
# ============================================================================
DEFAULT_CLUSTER_NAME="my-redis"
DEFAULT_DISPLAY_NAME="My Redis Cluster"
DEFAULT_ENGINE="redis"
DEFAULT_VERSION="7.2.12"
DEFAULT_MODE="replication"
DEFAULT_ENVIRONMENT="prod"
DEFAULT_ORG_NAME="default-org"
DEFAULT_REPLICAS=2
DEFAULT_STORAGE_SIZE=30
DEFAULT_CLASS_CODE="redis.replication.redis.2c2g.general"
...
KubeBlocks Redis Cluster Terraform Test Script
...
Examples:
    # Create a default Redis cluster
    ./run.sh -t 1
    ...
    ./run.sh -t 1 \\
        ...
        -r 3 \\
        -s 100 \\
        -cc "redis.replication.redis.4c8g.performance"
    
    # Scale up compute resources
    ./run.sh -t 4 \\
        -cc "redis.replication.redis.2c4g.general"
...
terraform_init_and_apply() {
    ...
    echo "Running: terraform plan -out redis_plan"
    terraform plan -out=redis_plan -var-file=terraform.tfvars
    
    echo ""
    echo "Running: terraform apply redis_plan"
    terraform apply redis_plan
