# Redis Terraform Test Script Guide

## 📖 Overview

The `run.sh` script provides a command-line interface for managing Redis clusters on KubeBlocks Cloud using Terraform. It simplifies cluster operations by allowing you to configure and execute Terraform commands through simple command-line parameters.
...
**What this does:**
- Creates a single-replica Redis cluster
- 10GB storage
...
**What this does:**
- Updates Redis configuration parameters
...
echo "Deploying Redis cluster: $CLUSTER_NAME"
...
- [Redis Example README](README.md)
